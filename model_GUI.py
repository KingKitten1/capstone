...
model = load_model('capstone files/keras_model.h5')

# Load the labels
label_path = 'capstone files/labels.txt'
class_names = open(label_path, "r").readlines()
test_image_path = 'capstone files/ILSVRC2012_val_00000994.JPEG'
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

# initialize GUI
top = tk.Tk()
top.geometry('800x600')
top.title('fish image classification')
...
heading = Label(top, text="fish Image Classifier", pady=20, font=('arial', 20, 'bold'))
